...
const demographicsFormItems = (
    ...
    setDischargeDate
        ...
        },
        {
            ...
            //     <SelectOption value="N/A">Rather not say</SelectOption>
            //   </Select>
            // ),
        },
        {
        ...
        },
        {
            ...
            //     filterOption={true}
            //   >
            //     <SelectOption value="Aadhar">Aadhar</SelectOption>
            //     <SelectOption value="Pan card">Pan Card</SelectOption>
            //     <SelectOption value="Driving License">Driving License</SelectOption>
            //     <SelectOption value="Indian Passport">Indian Passport</SelectOption>
            //     <SelectOption value="Other Passport">Other Passport</SelectOption>
            //   </Select>
            // ),
        },
        {
...
const AddressFormItems = (props, setCountry, selectedCountry) => [
    {
        ...
        //       <SelectOption key={i} value={country.countryName}>
        //         {country.countryName}
        //       </SelectOption>
        //     ))}
        //   </Select>
            ...
            >
                {selectedCountry.length > 0 &&
                    selectedCountry[0]?.regions?.map((region, i) => (
                        <SelectOption key={i} value={region.name}>
                            {region.name}
                        </SelectOption>
                    ))}
            </Select>
