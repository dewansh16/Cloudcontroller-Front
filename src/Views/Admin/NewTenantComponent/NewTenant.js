...
function NewTenant({
    ...
    function checkAllWardsFilled() {
        ...
        //     return false;
        // } 
        // if (Object.keys(wardsInFloor).length === 0) {
        //     console.log("------ 2 ------");
        ...
        //         console.log("------ 3 ------", wardsInFloor[`floor_${i}`]);

        //         return false;
        //     }

        //     if (wardsInFloor[`floor_${i}`].wards.ward_count === null) {
        //         console.log("------ 4 ------", wardsInFloor[`floor_${i}`]);

        //         return false;
        //     } 
            
        //     for (
        //         var j = 1; j <= Object.keys(wardsInFloor[`floor_${i}`].wards).length; j++
        //     ) {
        //         if (
        //             !wardsInFloor[`floor_${i}`].wards[`ward_${j}`].bed_count ||
        //             wardsInFloor[`floor_${i}`].wards[`ward_${j}`].bed_count === null
        //         ) {
        //             console.log("if 1", !wardsInFloor[`floor_${i}`]);
        //             console.log("if 2", wardsInFloor[`floor_${i}`]);
        //             console.log("------ 5 ------", i, j);
        //             return false;
        //         }
        //     }
        ...
        if (!floors || !wards || !beds) { return false; }

        if (!!wardsInFloor[`floor_${floors}`].wards[`ward_${wards}`].bed_count) {
            return true;
        }
    ...
    console.log("wardsInFloor", wardsInFloor);
    console.log("floors", floors, "wards", wards, "beds", beds);
