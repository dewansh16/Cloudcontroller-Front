...
export default function PatientDetails(props) {
    ...
    useEffect(() => {
        patientApi
            ...
            .then((res) => {
                ...
                // setPatient(res.data.response.patients[0]);
                ...
                patientApi
                    ...
                    .then((res) => {
                        ...
                        locationApi
                            ...
                            .then((res) => {
                                console.log("res getLocationData", res.data);

                                // setLocationInventory(res.data.response.locations);
                                setLoading(false);
                                // console.log("locationInventory Data", res.data.response);
                            })
                            .catch((err) => {
                                console.log(err);
    ...
    console.log(patient, journeyDetails, locationInventory, isLoading);
